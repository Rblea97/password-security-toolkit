...
def main() -> int:
    ...
    parser.add_argument(
        "--version", action="version", version=f"SecurePass Toolkit v{VERSION}"
    )
    ...
    check_parser.add_argument(
        "--verbose", "-v", action="store_true", help="Show additional analysis details"
    )
    ...
    generate_parser.add_argument(
        "--no-symbols", action="store_true", help="Exclude symbols/punctuation"
    )
    ...
    batch_parser.add_argument(
        "file", help="Input file containing passwords (one per line)"
    )
    ...
    batch_parser.add_argument("--export", metavar="FILE", help="Export results to file")
