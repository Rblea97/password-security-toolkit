...
class TestEstimateCrackTime:
    ...
    def test_low_entropy(self):
        ...
        assert 'hours' in times['online_attack_100_per_second'] or 'minutes' in times['online_attack_100_per_second']
        assert 'instant' in times['offline_attack_10B_per_second'] or 'seconds' in times['offline_attack_10B_per_second']
    ...
    def test_medium_entropy(self):
        ...
        assert 'years' in times['online_attack_100_per_second'] or 'centuries' in times['online_attack_100_per_second']
    
    def test_high_entropy(self):
        """High entropy (80 bits) should be very secure."""
        times = estimate_crack_time(80)
        # 2^80 = massive number
        assert 'years' in times['online_attack_100_per_second'] or 'centuries' in times['online_attack_100_per_second'] or 'millennia' in times['online_attack_100_per_second']
